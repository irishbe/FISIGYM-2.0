 ...
 * @author bdlcc
 */
public class ClasesCliente extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("¡Tenemos talleres programados esta semana para ti!");

        jLabel3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel3.setText("Recuerda que tu sede predeterminada es:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClasesCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClasesCliente().setVisible(true);
            }
        });
    }
