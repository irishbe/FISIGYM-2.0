 ...
 * @author bdlcc
 */
public class GestionarGimnasios extends javax.swing.JFrame {

    /**
     * Creates new form adminGestionGimnasios
     */
    public GestionarGimnasios() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionarGimnasios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionarGimnasios().setVisible(true);
            }
        });
    }
