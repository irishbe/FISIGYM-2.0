...
public class SeleccionarSedeCtrl implements ActionListener{
    private SeleccionarSede sedesLogin;
    private Cliente cliente;
    
    public SeleccionarSedeCtrl(SeleccionarSede sedesLogin, Cliente cliente) {
